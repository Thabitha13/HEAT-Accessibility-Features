...
public class OptionsWindow {
  ...
  private JCheckBox deuteranopiaCheckBox; // Thabitha
  ...
  private void jbInit() throws Exception {
    ...
    // Thabitha: deuteranopia colour mode
    deuteranopiaCheckBox = new JCheckBox("Enable Deuteranopia (red-green) colour mode");
    deuteranopiaCheckBox.setSelected(
        "true".equals(managers.SettingsManager.getInstance().getSetting(utils.Settings.DEUTERANOPIA_MODE)));
    panelAccessibility.add(deuteranopiaCheckBox);
 ...
 /* Populate the font size combo boxes */
  ...
  public void getProperties() {
    ...
    deuteranopiaCheckBox.setSelected(
        "true".equals(sm.getSetting(utils.Settings.DEUTERANOPIA_MODE)));
  }
  ...
  /** Thabitha: returns whether deuteranopia mode is selected in the UI */
  public boolean isDeuteranopiaEnabled() {
    return deuteranopiaCheckBox.isSelected();
  }
